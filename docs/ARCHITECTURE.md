...
flowchart LR
  ...
  m_wahlomat_extended_analysis_wahlomat["wahlomat_extended_analysis/wahlomat.py"]
  ...
  m_wahlomat_extended_analysis_update_excel_csv --> m_wahlomat_extended_analysis_analysis
  m_wahlomat_extended_analysis_update_excel_csv --> m_wahlomat_extended_analysis_build_dataframe
  m_wahlomat_extended_analysis_update_excel_csv --> m_wahlomat_extended_analysis_build_metadata
```
