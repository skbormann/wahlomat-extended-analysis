...
flowchart LR
  ...
  m_update_excel_csv --> m_build_metadata
  m_wahlomat --> m_build_dataframe
  m_wahlomat --> m_build_graphs_from_csv
  m_wahlomat --> m_get_zip_files
  m_wahlomat --> m_update_excel_csv
```
