function write_1_fragen(){
	...
	rw += '<h4 class="wahl"><span class="redtxt">\n';
	
	lwKurzFrage = wom_html(WOMT_aThesen[S_nTheseAktuell][S_nSprache][0]);
	//lwKurzFrage = lwKurzFrage.replace(/\- /,"");
	rw += lwKurzFrage;
	rw += '<\/span> ('+wom_html(WOMT_aTexte["1_fragen_these"][S_nSprache])+' '+(S_nTheseAktuell+1)+' '+wom_html(WOMT_aTexte["1_fragen_von"][S_nSprache])+' '+WOMT_nThesen+')<\/h4>\n';
	rw += '<div class="b1">\n';
