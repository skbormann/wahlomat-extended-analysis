...
function write_3_parteiauswahl(){
    ...
    rw += '<div id="main">\n';
        ...
        rw += '<div class="intro" style="line-height:16px;padding-left:45px;">\n';
        rw += wom_html(WOMT_aTexte["3_text_partei_oben"][S_nSprache]);
        rw += '<br/><br/>\n';
        ...
        rowWidth = new Array(150,147,124);
            ...
            for (lRow = 0;lRow<3;lRow++){
                ...
                for (c = 0;c<lRenderReihenfolge[lRow].length;c++){
                    ...
                    if (lFixValue==1){
                        ...
                        rw += '<a style="line-height:14px" href="'+CONST_WSZW_URL+"?partei="+WOMT_aParteien_N2ID[lFixKey]+'&amp;ver=off" target="_blank" title="';
                ...
                for (c = 0;c<lRenderReihenfolge[lRow].length;c++){
                    ...
                    if (lFixValue!=1){
                        ...
                        rw += '" class="tt" tabindex="'+(18+(lFixKey*2)+1)+'">';
                            ...
                            if (WOMT_aParteien_N2ID[lFixKey] == 302) {
                                rw += wom_html('DIE FREIHEIT'); 
                                rw += ' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Niedersachsen';
                            } else {
                                rw += wom_html(WOMT_aParteien[lFixKey][S_nSprache][1]);
                            }
        ...
        rw += '<div class="intro" style="margin-top:20px;line-height:16px;padding-left:45px;width:420px;">\n';
        rw += wom_html(WOMT_aTexte["3_text_partei_unten"][S_nSprache]);
		rw += '<\/div>\n';
