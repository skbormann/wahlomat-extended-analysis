...
WOMT_aTexte['0_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Landtagswahl in Rheinland-Pfalz 2021. In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. Jetzt den Wahl-O-Mat spielen: [WOMURL]';
WOMT_aTexte['0_share_email_subject'] = new Array();
WOMT_aTexte['0_share_email_subject'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 spielen';
...
WOMT_aTexte['0_share_twitter_text'][0] = 'Jetzt den Wahl-O-Mat zur #Landtagswahl in #Rheinland-Pfalz 2021 spielen @bpb_de #WahlOMat #rlpwahl';
...
WOMT_aTexte['0_share_whatsapp_text'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 spielen [WOMURL]';
...
WOMT_aTexte['0_title_h2'][0] = 'Rheinland-Pfalz 2021';
...
WOMT_aTexte['0_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 | Start';
...
WOMT_aTexte['1_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Landtagswahl in Rheinland-Pfalz 2021. <br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. <br/><br/>These [NR]: <br/>[LANGTHESE] <br/><br/>Jetzt den Wahl-O-Mat spielen: [WOMURL]';
WOMT_aTexte['1_share_email_subject'] = new Array();
WOMT_aTexte['1_share_email_subject'][0] = 'Wahl-O-Mat Landtagswahl in Rheinland-Pfalz 2021 - These [NR]: [KURZTHESE]';
...
WOMT_aTexte['1_share_twitter_text'][0] = 'These [NR] #WahlOMat #Rheinland-Pfalz #rlpwahl : [LANGTHESE]';
...
WOMT_aTexte['1_share_whatsapp_text'][0] = 'These [NR] Wahl-O-Mat Landtagswahl in Rheinland-Pfalz 2021: [LANGTHESE] [WOMURL]';
...
WOMT_aTexte['1_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 | These';
...
WOMT_aTexte['2_gewichtung_beschreibung'][0] = 'Welche Thesen sind Ihnen besonders wichtig? Klicken Sie auf den Kreis links von der These, um diese mit doppelter Gewichtung in die Berechnung einfließen zu lassen. Ihr Ergebnis wird dadurch genauer.';
...
WOMT_aTexte['2_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 | Gewichtung';
...
WOMT_aTexte['3_text_imparlament'][0] = 'Parteien, die zurzeit mit einer Fraktion im Landtag vertreten sind:';
...
WOMT_aTexte['3_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 | Parteien';
...
WOMT_aTexte['4_pdf_text'][0] = 'Eine Übersicht mit den Antworten aller [PARTEIENANZAHL] Parteien auf die Wahl-O-Mat-Thesen finden Sie hier als <a href="[PDF_URL]" class="link--intern" target="_blank">PDF.</a>';
...
WOMT_aTexte['7_springe_zu_inhalt'][0] = 'Springe zum Inhalt';
...
WOMT_aTexte['navigation_share_mail_betreff'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 spielen';
WOMT_aTexte['navigation_share_mail_mailtext'] = new Array();
WOMT_aTexte['navigation_share_mail_mailtext'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Landtagswahl in Rheinland-Pfalz 2021. In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. Jetzt den Wahl-O-Mat spielen: https://www.wahl-o-mat.de/rheinlandpfalz2021/';
...
WOMT_aTexte['overlay_bitv_text'][0] = '<p>Die Bundeszentrale für politische Bildung/bpb ist bemüht, das Online-Angebot www.wahl-o-mat.de barrierefrei zugänglich zu machen. Rechtsgrundlage sind das Behindertengleichstellungsgesetz (BGG) und die Barrierefreie-Informationstechnik-Verordnung (BITV).</p><p>Als zusätzlichen Service bietet die Bundeszentrale für politische Bildung/bpb auf www.wahl-o-mat.de eine Vorlesefunktion an. Die Vorlesesoftware Readspeaker liest Ihnen die Texte im Wahl-O-Mat vor, dafür müssen Sie keine zusätzliche Software herunterladen. Dieser Dienst verbessert die Zugänglichkeit der Inhalte und ist eine Hilfestellung für Nutzerinnen und Nutzer, die Probleme beim Lesen von Onlinetexten haben.</p><p>Sollten Ihnen Mängel in Bezug auf die barrierefreie Gestaltung von <a class="link--extern" href="https://www.wahl-o-mat.de" target="_blank"><span>www.wahl-o-mat.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a> auffallen, können Sie sich an das Wahl-O-Mat Team der Bundeszentrale für politische Bildung/bpb unter <a class="link--intern" href="mailto:info@wahl-o-mat.de">info@wahl-o-mat.de</a> wenden.</p><p>Bonn, den 10. Februar 2021</p>';
...
WOMT_aTexte['overlay_impressum_text'][0] = '<p>Der Wahl-O-Mat zur Landtagswahl Rheinland-Pfalz 2021 ist ein Produkt der <a class="link--extern" href="https://www.bpb.de" target="_blank"><span>Bundeszentrale für politische Bildung</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a> und der <a class="link--extern" href="https://www.politische-bildung.rlp.de/" target="_blank"><span>Landeszentrale für politische Bildung Rheinland-Pfalz</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><p>Thesen und Inhalte des Wahl-O-Mat wurden von einem Redaktionsteam aus Jungwählerinnen und Jungwählern aus Rheinland-Pfalz, Expertinnen und Experten aus Wissenschaft, Journalismus und Bildung sowie den Verantwortlichen der Bundeszentrale für politische Bildung und der Landeszentrale für politische Bildung Rheinland-Pfalz entwickelt.</p><h2>Herausgeber</h2><p>Bundeszentrale für politische Bildung/bpb, Bonn © 2021<br/>Verantwortlich gemäß § 55 RStV: Thorsten Schilling<br/><a title="" class="link--intern" href="mailto:schilling@bpb.de">schilling@bpb.de</a></p><h2>Projektleitung<br/>für die Bundeszentrale für politische Bildung/bpb</h2><p>Pamela Brandt<br/>Martin Hetterich<br/>Lea Schrenk</p><p>Adenauerallee 86<br/>53113 Bonn<br/>Tel.: +49 228 99515-0<br/>Fax: +49 228 99515-405<br/>E-Mail: <a title="" class="link--intern" href="mailto:info@wahl-o-mat.de">info@wahl-o-mat.de</a><br/>Internet: <a class="link--extern" href="https://www.bpb.de" target="_blank"><span>www.bpb.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Sie haben Fragen?</h2><p>Treten Sie mit unserem Bürgerservice in Kontakt:<br/>Tel.: 0228 99515-0<br/>Fax: 0228 99515-113<br/>E-Mail: <a title="" class="link--intern" href="mailto:info@bpb.de">info@bpb.de</a><br/>Twitter: <a class="link--extern" href="https://twitter.com/frag_die_bpb"  target="_blank"><span>@frag_die_bpb</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Pressekontakt bpb</h2><p>Journalistinnen und Journalisten wenden sich bitte an die <a class="link--extern" href="https://www.bpb.de/presse/49534/pressekontakt" target="_blank"><span>Pressestelle</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><h2>Projektleitung für die Landeszentrale für politische Bildung Rheinland-Pfalz</h2><p>Dr. Sarah Scholl-Schneider<br/>Landeszentrale für politische Bildung Rheinland-Pfalz <br/>Am Kronberger Hof 6<br/>55116 Mainz<br/>Telefon: 06131 16 2970<br/>Telefax: 06131 16 17 2970<br/>E-Mail: <a title="" class="link--intern" href="lpb.zentrale@politische-bildung-rlp.de">lpb.zentrale@politische-bildung-rlp.de</a><br/>Internet: <a class="link--extern" href="https://www.politische-bildung.rlp.de/" target="_blank"><span>www.politische-bildung-rlp.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Inhalt und Redaktion</h2><p><img class="wom_pic1" alt="Gruppenfoto der Redaktion" title="Gruppenfoto der Redaktion" width="100%" src="version/pic_impressum.jpg"/></p><br/><h3>Jungwählerinnen und Jungwähler</h3><p>Max Aehle, Nathalie Irini Anagnostou, Johannes Ammon, Elisabeth Gold, Christopher Groß, Verona Haucke, Antonia Heser, Henning Kröger, Hannah Leisch, Gloria Margarete Leo, Niklas Otto, Nahum Taye Mulugeta, Pirmin Scheel, Franziska Schmitgen, Eva Thomsen</p><h3>Expertinnen und Experten aus Wissenschaft, Journalismus und Bildung</h3><p>Tanja Binder, Karin Dauscher, Wolf Dittmayer, Prof. Dr. Manuela Glaab, Samuel Groesch, Daniel Hagemann, Prof. Dr. Uwe Jun, Markus Jung, Prof. Dr. Stefan Marschall</p><h3>Landeszentrale für politische Bildung Rheinland-Pfalz</h3><p>Franzi Bach, Jessica Maron, Lion Merten, Dr. Sarah Scholl-Schneider</p><h3>Bundeszentrale für politische Bildung</h3><p>Pamela Brandt, Martin Hetterich, Lea Schrenk</p><h2>Umsetzung, Gestaltungskonzept & Design</h2><p>3pc GmbH Neue Kommunikation, Berlin<br/>E-Mail: <a title="" class="link--intern" href="mailto:info@3pc.de">info@3pc.de</a><br/>Internet: <a class="link--extern" href="https://3pc.de" target="_blank"><span>https://3pc.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Programmierung</h2><p>GLAMUS GmbH<br/>E-Mail: <a title="" class="link--intern" href="mailto:santo@glamus.de">santo@glamus.de</a><br/>Internet: <a class="link--extern" href="https://www.glamus.de" target="_blank"><span>https://www.glamus.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Nach einer Idee von</h2><p><a class="link--extern" href="http://www.prodemos.nl/" target="_blank"><span>ProDemos - Huis voor democratie en rechtsstaat</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a><br/>Den Haag/Niederlande</p><p>Die Vervielfältigung, Verbreitung und die öffentliche Wiedergabe des Wahl-O-Mat ist nicht gestattet. Der Wahl-O-Mat ist urheberrechtlich geschützt.</p>';
...
WOMT_aTexte['popup_faq_11_text'][0] = '<p><strong>Der Wahl-O-Mat behandelt viele Wahlkampfthemen oder sachpolitische Fragen, zu denen sich auch extremistische Parteien positionieren, ohne damit ihre extremistische Grundeinstellung zu erkennen zu geben. Achten Sie daher genau auf Thesen, die Grundeinstellungen zu den für Sie wichtigen Themen abfragen und beachten Sie die Begründungen der Parteien zu den Positionen.</strong></p><p>Die 38 Thesen im Wahl-O-Mat behandeln konkrete Inhalte der aktuellen Politik. Denn schließlich verfolgt der Wahl-O-Mat das Ziel, über die wichtigsten Wahlkampfthemen zu informieren. Zu diesen Inhalten beziehen auch extremistische Parteien eine Position. Ob zum Beispiel in allen Gaststätten ein absolutes Rauchverbot gelten soll, lässt wahrscheinlich keine extremistische Grundeinstellung einer Partei erkennen. Oft ist die Ideologie einer Partei in ihren Begründungen im Wahl-O-Mat zu finden. Es lohnt sich, diese genau zu lesen.</p><p>Eine mittlere oder hohe Übereinstimmung mit extremistischen Parteien im Wahl-O-Mat bedeutet daher nicht unbedingt, dass Sie selbst rechts- oder linksextremistisch eingestellt sind. Einen spannenden Text zu diesem Thema finden Sie <a class="link--extern" href="https://www.bpb.de/45464/bin-ich-jetzt-ein-nazi"><span>hier</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>. Welche Parteien als extremistisch und somit als Gefahr für die Demokratie gelten, erfahren Sie auf den Seiten des Verfassungsschutzes:</p><ul class="wom-faq"><li><a class="link--extern" href="https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/sicherheit/vsb-2019-gesamt.pdf;jsessionid=60584881E9E46107408B6BFEFB59018D.2_cid373?__blob=publicationFile&amp;v=10" target="_blank"><span>Bundesministerium des Innern, für Bau und Heimat: Verfassungsschutzbericht 2019 (PDF, 4,8 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li><li><a class="link--extern" href="https://mdi.rlp.de/fileadmin/isim/Unsere_Themen/Sicherheit/Verfassungsschutz/Dokumente/Verfassungsschutzbericht_2019.pdf" target="_blank"><span>Ministerium des Innern und für Sport Rheinland-Pfalz: Verfassungsschutzbericht 2019 (PDF, 3,4 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li></ul>';
...
WOMT_aTexte['popup_faq_18_frage'][0] = 'Wie oft wurde der Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz bereits genutzt?';
WOMT_aTexte['popup_faq_18_text'] = new Array();
WOMT_aTexte['popup_faq_18_text'][0] = '<p>Bislang wurde der Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz bereits [NUTZUNGEN] Mal genutzt.</p>';
...
WOMT_aTexte['popup_faq_2_text'][0] = '<p><strong>Zur Teilnahme am Wahl-O-Mat sind grundsätzlich alle Parteien eingeladen, die sich um die anteilsmäßige Verteilung der Sitze im Parlament – in Rheinland-Pfalz mit einer Landes- oder Bezirksliste - bewerben. Über die Teilnahme am Wahl-O-Mat entscheiden die Parteien selbst.</strong></p><p>Beim Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 wurden alle Parteien zur Teilnahme am Wahl-O-Mat eingeladen, die vom Landeswahlausschuss zur Landtagswahl 2021 mit einer Landes- oder Bezirksliste zugelassen wurden. Eine Übersicht aller zugelassenen Parteien sowie eine kurze Beschreibung finden Sie unter <a title="Wer steht zur Wahl? (Dieser Link öffnet sich in einem neuen Fenster.)" class="link--extern" href="https://www.wahl-o-mat.de/rlp2021/wszw.php" target="_blank"><span>www.wer-steht-zur-wahl.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><p>Alle 13 Parteien, die mit einer Landes- oder Bezirksliste zugelassen wurden, haben die Einladung angenommen und die Thesen beantwortet. Im Wahl-O-Mat können auch Parteien vertreten sein, die vom Verfassungsschutz des Bundes oder der Länder beobachtet und als extremistisch eingestuft werden. Welche Parteien als extremistisch eingestuft werden, können Sie auf den Seiten des Verfassungsschutzes nachlesen:</p><ul class="wom-faq"><li><a class="link--extern" href="https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/sicherheit/vsb-2019-gesamt.pdf;jsessionid=60584881E9E46107408B6BFEFB59018D.2_cid373?__blob=publicationFile&amp;v=10" target="_blank"><span>Bundesministerium des Innern, für Bau und Heimat: Verfassungsschutzbericht 2019 (PDF, 4,8 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li><li><a class="link--extern" href="https://mdi.rlp.de/fileadmin/isim/Unsere_Themen/Sicherheit/Verfassungsschutz/Dokumente/Verfassungsschutzbericht_2019.pdf" target="_blank"><span>Ministerium des Innern und für Sport Rheinland-Pfalz: Verfassungsschutzbericht 2019 (PDF, 3,4 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li></ul>';
...
WOMT_aTexte['popup_impressum_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021 | Impressum';
...
WOMT_aTexte['share_twitter_start'][0] = '#wahlomat Wahl zur Landtagswahl in Rheinland-Pfalz 2021';
WOMT_aTexte['wahlomat_content_head'] = new Array();
WOMT_aTexte['wahlomat_content_head'][0] = 'Wahl-O-Mat Landtagswahl in Rheinland-Pfalz 2021';
...
WOMT_aTexte['wahlomat_head_description'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021';
WOMT_aTexte['wahlomat_head_keywords'] = new Array();
WOMT_aTexte['wahlomat_head_keywords'][0] = 'wahlomat,wahl-o-mat, www.wahlomat.de, www.wahl-o-mat.de, Landtagswahl in Rheinland-Pfalz 2021, Rheinland-Pfalz 2021, Rheinland-Pfalz, Landtagswahl, Wahlen';
WOMT_aTexte['wahlomat_head_titel'] = new Array();
WOMT_aTexte['wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Rheinland-Pfalz 2021';
...
WOMT_aTexte['wahlomat_kopf_link_lzpb_title'][0] = 'Landeszentrale für politische Bildung Rheinland-Pfalz';
...
WOMT_sCheckSumTexte[0] = '7112057d4ca57ca7718a225487525023';
WOMT_sGenerationTimeTexte = '12.05.2021 06:22:13';
