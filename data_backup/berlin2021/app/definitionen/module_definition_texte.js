...
WOMT_aTexte['0_intro_text_1'][0] = '33 von 34 Parteien, die mit einer Landes- oder Bezirksliste zur Wahl antreten, haben die Wahl-O-Mat-Thesen beantwortet. Jetzt sind Sie an der Reihe: Vergleichen Sie Ihre Standpunkte mit den Antworten der Parteien.';
...
WOMT_aTexte['0_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Abgeordnetenhauswahl in Berlin 2021. <br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. <br/> <br/><br/>Jetzt den Wahl-O-Mat spielen: <br/>[WOMURL]';
WOMT_aTexte['0_share_email_subject'] = new Array();
WOMT_aTexte['0_share_email_subject'][0] = 'Jetzt den Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 spielen';
...
WOMT_aTexte['0_share_twitter_text'][0] = 'Jetzt den Wahl-O-Mat zur #Abgeordnetenhauswahl in #Berlin 2021 spielen @bpb_de #WahlOMat #ahw11';
...
WOMT_aTexte['0_share_whatsapp_text'][0] = 'Jetzt den Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 spielen [WOMURL]';
...
WOMT_aTexte['0_title_h2'][0] = 'Berlin 2021';
...
WOMT_aTexte['0_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 | Start';
...
WOMT_aTexte['1_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Abgeordnetenhauswahl in Berlin 2021. <br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. <br/><br/>These [NR]:<br/>[LANGTHESE]<br/> <br/><br/>Jetzt den Wahl-O-Mat spielen: [WOMURL]';
WOMT_aTexte['1_share_email_subject'] = new Array();
WOMT_aTexte['1_share_email_subject'][0] = 'Wahl-O-Mat Abgeordnetenhauswahl in Berlin 2021 - These [NR]: [KURZTHESE]';
...
WOMT_aTexte['1_share_twitter_text'][0] = 'These [NR] #WahlOMat #Berlin #ahw11: [LANGTHESE]';
...
WOMT_aTexte['1_share_whatsapp_text'][0] = 'These [NR] Wahl-O-Mat Abgeordnetenhauswahl in Berlin 2021: [LANGTHESE] [WOMURL]';
...
WOMT_aTexte['1_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 | These';
...
WOMT_aTexte['2_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 | Gewichtung';
...
WOMT_aTexte['3_text_imparlament'][0] = 'Parteien, die zurzeit mit einer Fraktion im Abgeordnetenhaus vertreten sind:';
...
WOMT_aTexte['3_text_unten'][0] = 'Die Reihenfolge der Parteien richtet sich nach ihrem Wahlergebnis bei der letzten Wahl. Parteien, die im Abgeordnetenhaus von Berlin vertreten sind, erscheinen bei gleicher Abgeordnetenzahl nach Alphabet. Parteien, die bei der letzten Wahl nicht teilgenommen haben, erscheinen anschließend in alphabetischer Reihenfolge.';
...
WOMT_aTexte['3_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 | Parteien';
...
WOMT_aTexte['navigation_share_mail_betreff'][0] = 'Jetzt den Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 spielen';
WOMT_aTexte['navigation_share_mail_mailtext'] = new Array();
WOMT_aTexte['navigation_share_mail_mailtext'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Abgeordnetenhauswahl in Berlin 2021<br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen.<br/><br/>Jetzt den Wahl-O-Mat spielen:<br/>https://www.wahl-o-mat.de/berlin2021/';
...
WOMT_aTexte['popup_impressum_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021 | Impressum';
...
WOMT_aTexte['share_twitter_start'][0] = '#wahlomat Wahl zur Abgeordnetenhauswahl in Berlin 2021';
WOMT_aTexte['wahlomat_content_head'] = new Array();
WOMT_aTexte['wahlomat_content_head'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021';
...
WOMT_aTexte['wahlomat_head_description'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021';
WOMT_aTexte['wahlomat_head_keywords'] = new Array();
WOMT_aTexte['wahlomat_head_keywords'][0] = 'wahlomat,wahl-o-mat, www.wahlomat.de, www.wahl-o-mat.de, Abgeordnetenhauswahl in Berlin 2021, Berlin 2021, Berlin, Abgeordnetenhauswahl, Landtagswahl, Wahlen';
WOMT_aTexte['wahlomat_head_titel'] = new Array();
WOMT_aTexte['wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Abgeordnetenhauswahl in Berlin 2021';
...
WOMT_aTexte['wahlomat_kopf_link_lzpb_title'][0] = 'Berliner Landeszentrale für politische Bildung';
...
WOMT_sCheckSumTexte[0] = 'a714f89c1c010645489890f560067d9c';
WOMT_sGenerationTimeTexte = '03.09.2021 15:44:19';
