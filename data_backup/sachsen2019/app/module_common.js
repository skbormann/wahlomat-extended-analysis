...
var CONST_WOMT_BL_VERSION					= "sachsen2019";
var CONST_WOMT_PATH							= "sachsen2019";
            ...
            rw += '<footer class="wom_footer" aria-labelledby="wom_footertext">\n';
                ...
                rw += '<li>\n';
                  rw += '<div class="wom_b15 wom_fh">\n';
                    rw += '<a href="https://www.saechsische.de" title="Link zum Medienpartner: S&Auml;CHSISCHE (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>S&Auml;CHSISCHE<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
