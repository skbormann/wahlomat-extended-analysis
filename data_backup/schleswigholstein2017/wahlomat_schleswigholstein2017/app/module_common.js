...
var CONST_WOMT_BL_VERSION					= "schleswigholstein2017";
var CONST_WOMT_PATH							= "schleswigholstein2017";
		...
		//return '';
            ...
            rw += '<div class="wom_footer"  role="navigation" style="margin-top:0px">\n';
                ...
                rw += '<div class="wom_b2 wom_fh">\n';
                    rw += '<a href="http://www.zeit.de" title="zeit.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="712"><span>zeit.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                ...
                rw += '<div class="wom_b4 wom_fh">\n';
                    rw += '<a href="http://www.welt.de" title="welt.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="714"><span>welt.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b5 wom_fh">\n';
                    rw += '<a href="http://www.handelsblatt.com" title="handelsblatt.com ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="715"><span>handelsblatt.com<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b6 wom_fh">\n';
                    rw += '<a href="http://www.wiwo.de" title="wiwo.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>wiwo.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b7 wom_fh">\n';
                    rw += '<a href="http://www.faz.net" title="faz.net ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="717"><span>faz.net<\/span><\/a>\n';
                rw += '<\/div>\n';
                
                rw += '<div class="wom_b8 wom_fh">\n';
                    rw += '<a href="http://www.focus.de" title="focus.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="718"><span>focus.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b9 wom_fh">\n';
                    rw += '<a href="http://www.sueddeutsche.de" title="sueddeutsche.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>sueddeutsche.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                ...
                rw += '<div class="wom_b11 wom_fh">\n';
                    rw += '<a href="https://www.merkur.de" title="merkur.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="721"><span>merkur.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                ...
                rw += '<div class="wom_b13 wom_fh">\n';
                    rw += '<a href="http://www.t-online.de" title="t-online.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="721"><span>t-online.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b14 wom_fh">\n';
                    rw += '<a href="http://www.msn.de" title="msn.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="721"><span>msn.de<\/span><\/a>\n';
                rw += '<\/div>\n';
