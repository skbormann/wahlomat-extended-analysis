...
var CONST_WOMT_BL_VERSION					= "hamburg2015";
var CONST_WOMT_PATH							= "hamburg2015";
	...
	&&(gStatusURL_Status!="0")){
		//return '';
            ...
            rw += '<div class="footer" style="margin-top:0px">\n';
                ...
                rw += '<div class="b10 fh">\n';
                rw += '<a href="http://www.hamburg.de" title="hamburg.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="720"><span>hamburg.de<\/span><\/a>\n';
                rw += '<\/div>\n';
		
                rw += '<div class="b11 fh">\n';
                rw += '<a href="http://du-bist-entscheidend.de" title="du-bist-entscheidend.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="721"><span>du-bist-entscheidend.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                
                rw += '<div class="b12 fh">\n';
                rw += '<a href="http://www.radiohamburg.de" title="radiohamburg.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>radiohamburg.de<\/span><\/a>\n';
                rw += '<\/div>\n';
