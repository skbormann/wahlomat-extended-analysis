...
function check_umfrage() {
    ...
    if (Math.floor((Math.random() * umfrage_max)) <= umfrage_often) {
        umfrageurl              = 'https://umfrage.wahl-o-mat.de/bayern2018/umfrage.html';
        waitmilliseconds        = 15000;
        S_UmfrageJUrl           = 'https://umfrage.wahl-o-mat.de/bayern2018/umfrage.html';                  
...
function umfrage_open() {
 	umfrage_win = window.open(S_UmfrageOpenUrl, 'UmfrageBayern2018', S_UmfrageJPopupOptions);
