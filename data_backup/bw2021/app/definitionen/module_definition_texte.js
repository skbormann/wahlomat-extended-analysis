...
WOMT_aTexte['0_intro_text_1'][0] = 'Alle [PARTEIENANZAHL] Parteien, die mit einem Wahlvorschlag zur Wahl antreten, haben die Wahl-O-Mat-Thesen beantwortet. Jetzt sind Sie an der Reihe: Vergleichen Sie Ihre Standpunkte mit den Antworten der Parteien.';
...
WOMT_aTexte['0_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Bürgerschaftswahl in Hamburg 2020. <br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. <br/> <br/><br/>Jetzt den Wahl-O-Mat spielen: <br/>[WOMURL]';
WOMT_aTexte['0_share_email_subject'] = new Array();
WOMT_aTexte['0_share_email_subject'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 spielen';
...
WOMT_aTexte['0_share_twitter_text'][0] = 'Jetzt den Wahl-O-Mat zur #Landtagswahl in #Baden-Württemberg 2021 spielen @bpb_de #WahlOMat #bwwahl';
...
WOMT_aTexte['0_share_whatsapp_text'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 spielen [WOMURL]';
...
WOMT_aTexte['0_title_h2'][0] = 'Baden-Württemberg 2021';
...
WOMT_aTexte['0_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 | Start';
...
WOMT_aTexte['1_share_email_body'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Landtagswahl in Baden-Württemberg 2021. <br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen. <br/><br/>These [NR]:<br/>[LANGTHESE]<br/> <br/><br/>Jetzt den Wahl-O-Mat spielen: [WOMURL]';
WOMT_aTexte['1_share_email_subject'] = new Array();
WOMT_aTexte['1_share_email_subject'][0] = 'Wahl-O-Mat Landtagswahl in Baden-Württemberg 2021 - These [NR]: [KURZTHESE]';
...
WOMT_aTexte['1_share_twitter_text'][0] = 'These [NR] #WahlOMat #Baden-Württemberg #bwwahl : [LANGTHESE]';
...
WOMT_aTexte['1_share_whatsapp_text'][0] = 'These [NR] Wahl-O-Mat Landtagswahl in Baden-Württemberg 2021: [LANGTHESE] [WOMURL]';
...
WOMT_aTexte['1_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 | These';
...
WOMT_aTexte['2_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 | Gewichtung';
...
WOMT_aTexte['3_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 | Parteien';
...
WOMT_aTexte['navigation_share_mail_betreff'][0] = 'Jetzt den Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 spielen';
WOMT_aTexte['navigation_share_mail_mailtext'] = new Array();
WOMT_aTexte['navigation_share_mail_mailtext'][0] = 'Der Wahl-O-Mat ist das Frage-und-Antwort-Tool zur Landtagswahl in Baden-Württemberg 2021<br/><br/>In 38 Thesen können Sie Ihre Antworten mit denen der Parteien vergleichen.<br/><br/>Jetzt den Wahl-O-Mat spielen:<br/>https://www.wahl-o-mat.de/bw2021/';
...
WOMT_aTexte['overlay_impressum_text'][0] = '<p>Der Wahl-O-Mat zur Landtagswahl Baden-Württemberg 2021 ist ein Produkt der <a class="link--extern" href="https://www.bpb.de" target="_blank"><span>Bundeszentrale für politische Bildung</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a> und der <a class="link--extern" href="https://www.lpb-bw.de/" target="_blank"><span>Landeszentrale für politische Bildung Baden-Württemberg.</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><p>Thesen und Inhalte des Wahl-O-Mat wurden von einem Redaktionsteam aus Jungwählerinnen und Jungwählern aus Baden-Württemberg, Expertinnen und Experten aus Wissenschaft, Journalismus und Bildung sowie den Verantwortlichen der Bundeszentrale für politische Bildung/bpb und der Landeszentrale für politische Bildung Baden-Württemberg entwickelt.</p><h2>Herausgeber</h2><p>Bundeszentrale für politische Bildung/bpb, Bonn © 2021<br/>Verantwortlich gemäß § 55 RStV: Thorsten Schilling<br/><a class="link--intern" href="mailto:schilling@bpb.de">schilling@bpb.de</a></p><h2>Projektleitung<br/>für die Bundeszentrale für politische Bildung/bpb</h2><p>Pamela Brandt<br/>Martin Hetterich<br/>Lea Schrenk</p><p>Adenauerallee 86<br/>53113 Bonn<br/>Tel.: +49 228 99515-0<br/>Fax: +49 228 99515-405<br/>E-Mail: <a class="link--intern" href="mailto:info@wahl-o-mat.de">info@wahl-o-mat.de</a><br/>Internet: <a class="link--extern" href="https://www.bpb.de" target="_blank"><span>www.bpb.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Sie haben Fragen?</h2><p>Treten Sie mit unserem Bürgerservice in Kontakt:<br/>Tel.: 0228 99515-0<br/>Fax: 0228 99515-113<br/>E-Mail: <a class="link--intern" href="mailto:info@bpb.de">info@bpb.de</a><br/>Twitter: <a class="link--extern" href="https://twitter.com/frag_die_bpb"  target="_blank"><span>@frag_die_bpb</span><span class="sr-only">(Dieser Link zu Twitter öffnet sich in einem neuen Fenster.)</span></a></p><h2>Pressekontakt bpb</h2><p>Journalistinnen und Journalisten wenden sich bitte an die <a class="link--extern" href="https://www.bpb.de/presse/49534/pressekontakt" target="_blank"><span>Pressestelle</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><h2>Projektleitung für die Landeszentrale für politische Bildung Baden-Württemberg</h2><p>Prof. Dr. Michael Wehner</p><p>Landeszentrale für politische Bildung Baden-Württemberg, Außenstelle Freiburg<br/>Bertoldstraße 55<br/>79098 Freiburg i. Br.<br/>Telefon: 0761 20773-0<br/>Fax: 0761 20773-99<br/>E-Mail: <a class="link--intern" href="mailto:freiburg@lpb.bwl.de">freiburg@lpb.bwl.de</a><br/>E-Mail für Pressekontakt: <a class="link--intern" href="mailto:Michael.Wehner@lpb.bwl.de">Michael.Wehner@lpb.bwl.de</a><br/>Internet: <a class="link--extern" href="https://www.lpb-bw.de" target="_blank"><span>https://www.lpb-bw.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Inhalt und Redaktion</h2><p><img class="wom_pic1" alt="Gruppenfoto der Redaktion" title="Gruppenfoto der Redaktion" width="100%" src="version/pic_impressum.jpg"/></p><br/><h3>Jungwählerinnen und Jungwähler</h3><p>Stefan Bamesberger, Robin Fuchs, Dennis Hodzic, Lina Juretzko, Veronika Klein, Philip Mathew, Joanna Mornhinweg, Carolin Schneider, Theresa Schwär, Florian Seuffert, Albrecht Simang, Carlotta Stark, Roman Strauß, Franziska Strobel</p><h3>Expertinnen und Experten aus Wissenschaft, Journalismus und Bildung</h3><p>Tanja Binder, Prof. Dr. Marius R. Busemeyer, Wolf Dittmayer, Henrik Domansky, PD Dr. Felix Hörisch, Roland Muschel, Markus Pfalzgraf, Eva Schiller, Constantin Wurthmann</p><h3>Landeszentrale für politische Bildung Baden-Württemberg</h4><p>Ines Ayeb, Felix Fuhr, Felix Göttler, Lilli Hermann, Jeremy Mano, Raphael Mano, Prof. Dr. Michael Wehner</p><h3>Bundeszentrale für politische Bildung</h3><p>Pamela Brandt, Martin Hetterich, Lea Schrenk</p><h2>Umsetzung, Gestaltungskonzept & Design</h2><p>3pc GmbH Neue Kommunikation, Berlin<br/>E-Mail: <a class="link--intern" href="mailto:info@3pc.de">info@3pc.de</a><br/>Internet: <a class="link--extern" href="https://3pc.de" target="_blank"><span>https://3pc.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Programmierung</h2><p>GLAMUS GmbH<br/>E-Mail: <a class="link--intern" href="mailto:santo@glamus.de">santo@glamus.de</a><br/>Internet: <a class="link--extern" href="https://www.glamus.de" target="_blank"><span>https://www.glamus.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></p><h2>Nach einer Idee von</h2><p><a class="link--extern" href="http://www.prodemos.nl/" target="_blank"><span>ProDemos - Huis voor democratie en rechtsstaat</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a><br/>Den Haag/Niederlande</p><p>Die Vervielfältigung, Verbreitung und die öffentliche Wiedergabe des Wahl-O-Mat ist nicht gestattet. Der Wahl-O-Mat ist urheberrechtlich geschützt.</p>';
...
WOMT_aTexte['popup_faq_18_frage'][0] = 'Wie oft wurde der Wahl-O-Mat zur Landtagswahl in Baden-Württemberg bereits genutzt?';
WOMT_aTexte['popup_faq_18_text'] = new Array();
WOMT_aTexte['popup_faq_18_text'][0] = '<p>Bislang wurde der Wahl-O-Mat zur Landtagswahl in Baden-Württemberg bereits [NUTZUNGEN] Mal genutzt.</p>';
...
WOMT_aTexte['popup_faq_2_text'][0] = '<p><strong>Zur Teilnahme am Wahl-O-Mat sind grundsätzlich alle Parteien eingeladen, die sich um die anteilsmäßige Verteilung der Sitze im Parlament – in Baden-Württemberg mit einem Wahlvorschlag in mindestens einem Wahlkreis - bewerben. Über die Teilnahme am Wahl-O-Mat entscheiden die Parteien selbst.</strong></p><p>Beim Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 wurden alle Parteien zur Teilnahme am Wahl-O-Mat eingeladen, die von den Kreiswahlausschüssen zur Landtagswahl 2021 mit einem Wahlvorschlag zugelassen wurden. Eine Übersicht aller zugelassenen Parteien sowie eine kurze Beschreibung finden Sie unter <a class="link--extern" href="https://www.wahl-o-mat.de/bw2021/wszw.php" target="_blank"><span>www.wer-steht-zur-wahl.de</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a>.</p><p>Alle 21 Parteien, die mit einem Wahlvorschlag zugelassen wurden, haben die Einladung angenommen und die Thesen beantwortet. Im Wahl-O-Mat können auch Parteien vertreten sein, die vom Verfassungsschutz des Bundes oder der Länder beobachtet und als extremistisch eingestuft werden. Welche Parteien als extremistisch eingestuft werden, können Sie auf den Seiten des Verfassungsschutzes nachlesen:</p><ul class="wom-faq"><li><a class="link--extern" href="https://www.bmi.bund.de/SharedDocs/downloads/DE/publikationen/themen/sicherheit/vsb-2019-gesamt.pdf;jsessionid=60584881E9E46107408B6BFEFB59018D.2_cid373?__blob=publicationFile&v=10" target="_blank"><span>Bundesministerium des Innern, für Bau und Heimat: Verfassungsschutzbericht 2019 (PDF, 4,8 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li><li><a class="link--extern" href="https://www.verfassungsschutz-bw.de/site/pbs-bw-lfv-root/get/documents_E-1052710582/IV.Dachmandant/Datenquelle/PDF/2020_Aktuell/Verfassungsschutzbericht_BW_2019.pdf" target="_blank"><span>Ministerium für Inneres, Digitalisierung und Migration Baden-Württemberg: Verfassungsschutzbericht 2019 (PDF, 4,6 MB)</span><span class="sr-only">(Dieser Link öffnet sich in einem neuen Fenster.)</span></a></li></ul>';
...
WOMT_aTexte['popup_impressum_wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021 | Impressum';
...
WOMT_aTexte['share_twitter_start'][0] = '#wahlomat Wahl zur Landtagswahl in Baden-Württemberg 2021';
WOMT_aTexte['wahlomat_content_head'] = new Array();
WOMT_aTexte['wahlomat_content_head'][0] = 'Wahl-O-Mat Landtagswahl in Baden-Württemberg 2021';
...
WOMT_aTexte['wahlomat_head_description'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021';
WOMT_aTexte['wahlomat_head_keywords'] = new Array();
WOMT_aTexte['wahlomat_head_keywords'][0] = 'wahlomat,wahl-o-mat, www.wahlomat.de, www.wahl-o-mat.de, Landtagswahl in Baden-Württemberg 2021, Baden-Württemberg 2021, Baden-Württemberg, Landtagswahl, Wahlen';
WOMT_aTexte['wahlomat_head_titel'] = new Array();
WOMT_aTexte['wahlomat_head_titel'][0] = 'Wahl-O-Mat zur Landtagswahl in Baden-Württemberg 2021';
...
WOMT_aTexte['wahlomat_kopf_link_lzpb_title'][0] = 'Landeszentrale für politische Bildung Baden-Württemberg';
...
WOMT_sCheckSumTexte[0] = '69d664d12baa97c0eb27e0f33fade09e';
WOMT_sGenerationTimeTexte = '12.05.2021 06:39:12';
