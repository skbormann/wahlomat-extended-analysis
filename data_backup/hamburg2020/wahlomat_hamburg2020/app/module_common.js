...
var CONST_WOMT_BL_VERSION					= "hamburg2020";
var CONST_WOMT_PATH							= "hamburg2020";
            ...
            rw += '<ul>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b1 wom_fh">\n';
                        rw += '<a href="https://www.spiegel.de/" title="Link zum Medienpartner: Spiegel Online (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>Spiegel Online<span>&nbsp;<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b2 wom_fh">\n';
                        rw += '<a href="https://www.focus.de/" title="Link zum Medienpartner: Focus (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>Focus<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b3 wom_fh">\n';
                        rw += '<a href="https://www.zeit.de/" title="Link zum Medienpartner: Zeit Online (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>Zeit Online<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b4 wom_fh">\n';
                        rw += '<a href="https://www.welt.de" title="Link zum Medienpartner: WELT (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>WELT<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b5 wom_fh">\n';
                        rw += '<a href="https://www.sueddeutsche.de/" title="Link zum Medienpartner: S&uuml;ddeutsche Zeitung (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>S&uuml;ddeutsche Zeitung<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b6 wom_fh">\n';
                        rw += '<a href="https://www.faz.net/" title="Link zum Medienpartner: FAZ (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>FAZ<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b7 wom_fh">\n';
                        rw += '<a href="https://www.taz.de/" title="Link zum Medienpartner: Taz (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>Taz<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b8 wom_fh">\n';
                        rw += '<a href="https://www.handelsblatt.com/" title="Link zum Medienpartner: Handelsblatt (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>Handelsblatt<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b9 wom_fh">\n';
                        rw += '<a href="https://www.wiwo.de/" title="Link zum Medienpartner: WirtschaftsWoche (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>WirtschaftsWoche<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                ...
                rw += '<li>\n';
                    rw += '<div class="wom_b11 wom_fh">\n';
                        rw += '<a href="https://www.zdf.de/" title="Link zum Medienpartner: ZDF (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>ZDF<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b12 wom_fh">\n';
                        rw += '<a href="https://www.1und1.de" title="Link zum Medienpartner: 1&amp;1 (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>1&amp;1<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                ...
                rw += '<li>\n';
                    rw += '<div class="wom_b14 wom_fh">\n';
                        rw += '<a href="https://www.rnd-news.de/" title="Link zum Medienpartner: RND RedaktionsNetzwerk Deutschland (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>RND RedaktionsNetzwerk Deutschland<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                    rw += '<div class="wom_b15 wom_fh">\n';
                        rw += '<a href="https://www.ippen-digital.de" title="Link zum Medienpartner: IPPEN DIGITAL (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="_blank"><span>IPPEN DIGITAL<\/span><\/a>\n';
                    rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
