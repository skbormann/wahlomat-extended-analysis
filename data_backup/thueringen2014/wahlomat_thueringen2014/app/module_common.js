...
var CONST_WOMT_BL_VERSION					= "thueringen2014";
var CONST_WOMT_PATH							= "thueringen2014";
	...
	&&(gStatusURL_Status!="0")){
		//return '';
            ...
            rw += '<div class="footer" style="margin-top:0px">\n';
                ...
                rw += '<div class="b12 fh">\n';
                rw += '<a href="http://www.mdr.de/thueringen" title="mdr.de/thueringen ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>mdr.de/thueringen</span></a>\n';
                rw += '</div>\n';
    
                rw += '<div class="b13 fh">\n';
                rw += '<a href="http://www.thueringer-allgemeine.de" title="thueringer-allgemeine.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>thueringer-allgemeine.de</span></a>\n';
                rw += '</div>\n';
                
                rw += '<div class="b14 fh">\n';
                rw += '<a href="http://www.lvz-online.de" title="lvz-online.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>lvz-online.de</span></a>\n';
                rw += '</div>\n';
