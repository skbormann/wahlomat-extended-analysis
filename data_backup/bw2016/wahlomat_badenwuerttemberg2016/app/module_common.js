// Version 1.00 vom 16.2.2016 20:55

var CONST_WOMT_BL_VERSION					= "bw2016";
var CONST_WOMT_PATH							= "bw2016";
		...
		//return '';
            ...
            rw += '<div class="wom_footer"  role="navigation" style="margin-top:0px">\n';
                ...
                rw += '<div class="wom_b2 wom_fh">\n';
                    rw += '<a href="http://www.sueddeutsche.de" title="sueddeutsche.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="712"><span>sueddeutsche.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                
                rw += '<div class="wom_b3 wom_fh">\n';
                    rw += '<a href="http://www.faz.net" title="faz.net ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="714"><span>faz.net<\/span><\/a>\n';
                rw += '<\/div>\n';
                
                rw += '<div class="wom_b4 wom_fh">\n';
                    rw += '<a href="http://www.zeit.de" title="zeit.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="716"><span>zeit.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                ...
                rw += '<div class="wom_b6 wom_fh">\n';
                    rw += '<a href="http://www.zdf.de" title="zdf.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="715"><span>zdf.de<\/span><\/a>\n';
                rw += '<\/div>\n';
        
                rw += '<div class="wom_b7 wom_fh">\n';
                    rw += '<a href="http://www.wiwo.de" title="wiwo.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="718"><span>wiwo.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                ...
                rw += '<div class="wom_b9 wom_fh">\n';
                    rw += '<a href="http://www.stern.de" title="stern.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>stern.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                
                //rw += '<div class="wom_b10 wom_fh">\n';
                //    rw += '<a href="http://www.1und1.de" title="1und1.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>1und1.de<\/span><\/a>\n';
                //rw += '<\/div>\n';
  

                rw += '<div class="wom_b11 wom_fh">\n';
                    rw += '<a href="http://www.taz.de" title="taz.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>taz.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b12 wom_fh">\n';
                    rw += '<a href="http://www.focus.de" title="focus.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>focus.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b13 wom_fh">\n';
                    rw += '<a href="http://www.tagesspiegel.de" title="tagesspiegel.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>tagesspiegel.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b14 wom_fh">\n';
                    rw += '<a href="http://www.ntz.de" title="ntz.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>ntz.de<\/span><\/a>\n';
                rw += '<\/div>\n';

                rw += '<div class="wom_b15 wom_fh">\n';
                    rw += '<a href="http://www.gaeubote.de" title="gaeubote.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>gaeubote.de<\/span><\/a>\n';
                rw += '<\/div>\n';
                rw += '<div class="wom_b16 wom_fh">\n';
                    rw += '<a href="http://www.pz-news.de" title="pz-news.de ' + wom_titletag(lTextNF)+ '" target="_blank" tabindex="719"><span>pz-news.de<\/span><\/a>\n';
                rw += '<\/div>\n';
