...
var CONST_WOMT_BL_VERSION					= "bremen2019";
var CONST_WOMT_PATH							= "bremen2019";
            ...
            rw += '<footer class="wom_footer" aria-labelledby="wom_footertext">\n';
                ...
                rw += '<li>\n';
                  rw += '<div class="wom_b15 wom_fh">\n';
                    rw += '<a href="https://taz.de/Nord/!p4650/" title="Link zum Medienpartner: TAZ (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="blank"><span>TAZ<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';
                ...
                rw += '<li>\n';
                  rw += '<div class="wom_b11 wom_fh">\n';
                    rw += '<a href="http://www.rnd-news.de/" title="Link zum Medienpartner: RND RedaktionsNetzwerk Deutschland (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="blank"><span>RND RedaktionsNetzwerk Deutschland<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                ...
                rw += '<li>\n';
                  rw += '<div class="wom_b13 wom_fh">\n';
                    rw += '<a href="https://www.weser-kurier.de/" title="Link zum Medienpartner: WESER-KURIER (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="blank"><span>WESER-KURIER<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';
                rw += '<li>\n';
                  rw += '<div class="wom_b14 wom_fh">\n';
                    rw += '<a href="https://www.butenunbinnen.de" title="Link zum Medienpartner: buten un binnen (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="blank"><span>buten un binnen<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';                         
              rw += '<\/ul>\n';
            rw += '<\/footer>\n';
