...
var CONST_WOMT_BL_VERSION					= "hessen2018";
var CONST_WOMT_PATH							= "hessen2018";
            ...
            rw += '<footer class="wom_footer" aria-labelledby="wom_footertext">\n';
                ...
                rw += '<li>\n';
                  rw += '<div class="wom_b14 wom_fh">\n';
                    rw += '<a href="http://www.vrm.de" title="Link zum Medienpartner: VRM (Dieser Link &ouml;ffnet sich in einem neuen Fenster.)" target="blank"><span>VRM<\/span><\/a>\n';
                  rw += '<\/div>\n';
                rw += '<\/li>\n';
              rw += '<\/ul>\n';
            rw += '<\/footer>\n';
