...
function write_5_detailauswertung() {
    ...
    rw += '<div class="wom_main_wrapper' + msl_get_view_class() + '" id="wom">';
        rw += '<ul class="wom_anchormenu" aria-label="Sprungnavigation">';
           rw += '<li><a href="#bnmotivations">' + wom_html(WOMT_aTexte["5_bn_start_text"][S_nSprache])+ '<\/a><\/li>';
           rw += '<li><a href="#bnthesen">' + wom_html(WOMT_aTexte["5_bn_thesen_text"][S_nSprache])+ '<\/a><\/li>';
           rw += '<li><a href="#bnself">' + wom_html(WOMT_aTexte["5_bn_self_text"][S_nSprache])+ '<\/a><\/li>';
           rw += '<li><a href="#bnparteien">' + wom_html(WOMT_aTexte["5_bn_parteien_text"][S_nSprache])+ '<\/a><\/li>';
                    ...
                    rw += '<nav class="wom_breadcrumb" id="bnbreadcrumb">';
    					...
    					rw += '<ul class="wom_breadcrumb_list">';
    						rw += '<li class="wom_first_position wom_active"><a href="" onclick="replaceIFrame(2);return false;">'
    						    ...
    						    + '<\/a><\/li>';
    						rw += '<li class="active"><a href="" onclick="replaceIFrame(3);return false;">' 
    						    + wom_html(WOMT_aTexte["bc_3_partei"][S_nSprache]) + '<\/a><\/li>';
    						rw += '<li class="wom_active"><a href="" onclick="replaceIFrame(4);return false;">' 
    						    + wom_html(WOMT_aTexte["bc_4_ergebnis"][S_nSprache]) + '<\/a><\/li>';
    						rw += '<li class="wom_active" aria-label="' 
    						        + wom_titletag(WOMT_aTexte["bc_hier"][S_nSprache]) 
    						        + ' ' 
    						        + WOMT_aTexte["bc_5_begruendungen"][S_nSprache] + 
    						    '"><strong>' + wom_html(WOMT_aTexte["bc_5_begruendungen"][S_nSprache]) + '<\/strong><\/li>';
    					rw += '<\/ul>';
				    ...
				    rw += '<div class="wom_thesen_vergleich" id="bnthesen">';
					    ...
					    rw += '<div class="wom_parteiantworten" id="bnself">';
						    ...
						    rw += '<div class="wom_antworten_box">';
    							rw += '<ul class="wom_votum_list';
    				    			    ...
    				    			    for (a = 0; a < WOMT_nThesen; a++) {
    									    ...
    									    switch(abstimmung){
                                                case -2:
                                                    parteiAntwortClass    = 'wom_avoid';
        								            parteiAntwortText     = WOMT_aTexte["5_antwort_partei_text_stimmtnichtzu"][S_nSprache];
    		                                        lText               = parteiAntwortText;
    		                                        lText               = lText.replace(/\[THESE\]/, WOMT_aThesen[a][S_nSprache][1]);
                                                    lText               = lText.replace(/\[PARTEI\]/, WOMT_aParteien[lNr][S_nSprache][1]);
    
        								            parteiImgAntwort = '<img src="media/pix/icon/votum_enthalten.png" alt="' + wom_titletag(lText) + '" />';
                                                case -1:
    		                                        ...
    		                                        lText               = lText.replace(/\[THESE\]/, WOMT_aThesen[a][S_nSprache][1]);
                                                    lText               = lText.replace(/\[PARTEI\]/, WOMT_aParteien[lNr][S_nSprache][1]);
        								            parteiImgAntwort = '<img src="media/pix/icon/votum_con.png" alt="' + wom_titletag(lText) + '" />';
                                                ...
                                                case 0:
    		                                        ...
    		                                        lText               = lText.replace(/\[THESE\]/, WOMT_aThesen[a][S_nSprache][1]);
                                                    lText               = lText.replace(/\[PARTEI\]/, WOMT_aParteien[lNr][S_nSprache][1]);
        								            parteiImgAntwort       = '<img src="media/pix/icon/votum_neutral.png" alt="' + wom_titletag(lText) + '" />';
                                                    break;
                                                case 1:
    		                                        ...
    		                                        lText               = lText.replace(/\[THESE\]/, WOMT_aThesen[a][S_nSprache][1]);
                                                    lText               = lText.replace(/\[PARTEI\]/, WOMT_aParteien[lNr][S_nSprache][1]);
        								            parteiImgAntwort = '<img src="media/pix/icon/votum_pro.png" alt="' + wom_titletag(lText) + '" />';
                                                    break;
                                            }
    				    			        ...
    				    			        rw += '<li' 
    				    			            ...
    				    			            rw += ' role="tab"><h3 class="wom_partei_balken" role="tab" aria-expanded="false" aria-controls="wom-tabpanel-partei' 
    				    			                + (lNr) + '-' + (a+1) + '" tabindex="0">' 
    				    			        ...
    				    			        rw += '">' + parteiImgAntwort 
    				    			            + '<\/p>';
    				    			        rw += '<div role="tabpanel" id="wom-tabpanel-partei' + (lNr) + '-' + (a+1) + '"><h4><span>';
    				    			            rw += wom_html(WOMT_aTexte["5_begruendung"][S_nSprache]) 
        				    ...
        				    rw += '<div class="wom_skip wom_ie8_neustart">';
            					rw += '<a href="" onclick="replaceIFrame(4);return false;" class="wom_previous" title="' + wom_titletag(WOMT_aTexte["5_btn_zurueck_title"][S_nSprache]) + '">' + wom_html(WOMT_aTexte["5_btn_zurueck_text"][S_nSprache]) + '<\/a>';
