    ...
    function snippet_vorlesen_popup(popup) {
        ...
        if ((CONST_WOMT_VORLESEN)&& (CONST_WOMT_VORLESEN_STATUS == 1)) {
            ...
            case 'faq':
                ...
                break;
            case 'impressum':
                tracks.push('vorlesen/popup_impressum_1.mp3');
                /*tracks.push('vorlesen/popup_impressum_ds_a.mp3');
                tracks.push('vorlesen/popup_impressum_ds_b.mp3');
                tracks.push('vorlesen/popup_impressum_ds_c_1.mp3');
                tracks.push('vorlesen/popup_impressum_ds_c_2.mp3');
                tracks.push('vorlesen/popup_impressum_ds_d.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_1.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_2.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_3.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_4.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_5.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_6.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_7.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_8.mp3');
                tracks.push('vorlesen/popup_impressum_ds_e_9.mp3');*/
                
                //tracks.push('vorlesen/popup_impressum_2.mp3');
                tracksText = 'Audio abspielen:';
                break;
            }
            return snippet_vorlesen_buttons(tracks, tracksText);
