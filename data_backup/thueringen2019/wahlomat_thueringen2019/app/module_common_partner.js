...
function check_umfrage() {
    ...
    if (Math.floor($.now()/1000) > 1572198900 ) {     // 27.10.2019 17:55:00
        return false;
    } 
    ...
    if (Math.floor((Math.random() * umfrage_max)) <= umfrage_often) {
        umfrageurl              = 'https://umfrage.wahl-o-mat.de/thueringen2019/umfrage.html';
        S_UmfrageJUrl           = 'https://umfrage.wahl-o-mat.de/thueringen2019/umfrage.html';                  
...
function umfrage_open() {
 	umfrage_win = window.open(S_UmfrageOpenUrl, 'UmfrageThueringen2019', S_UmfrageJPopupOptions);
